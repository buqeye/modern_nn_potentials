...
mpi_vals = np.linspace(100, 450, 40, dtype=np.dtype('f4'))
ls_deg_vals = np.linspace(0.01, 4, 5, dtype=np.dtype('f4'))
ls_tlab_vals = np.linspace(1, 150, 40, dtype=np.dtype('f4'))
lambda_vals = np.linspace(500, 1200, 40, dtype=np.dtype('f4'))
