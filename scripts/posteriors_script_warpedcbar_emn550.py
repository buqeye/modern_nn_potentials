...
lambda_vals = np.linspace(325, 925, 150, dtype=np.dtype('f4'))
...
warping_fn_kwargs = {"magnitude" : 20, "exponent" : 0.7}
...
scaling_fn_kwargs={"exponent" : 0.7}
